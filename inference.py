...
def infer(ears_norm, mars_norm, pucs_norm, moes_norm):
    ...
    # Set the alert delay time (in seconds)
    alert_delay = 10  # Example: Alert every 10 seconds if drowsy
    last_alert_time = 0  # To track when the last alert was made
        ...
        if label is not None:
            if label == 0:
                ...
                if current_time - last_alert_time > alert_delay:
                    # Voice alert if drowsy
                    engine.say("Please wake up, you are drowsy! Listen to a song to keep yourself awake.")
...
model_lstm_path = "C:/Users/bhuva/Downloads/Drowsiness-Detection-Mediapipe-main/Drowsiness-Detection-Mediapipe-main/models/clf_lstm_jit6.pth"
